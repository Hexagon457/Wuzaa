...
Wenn ihr mal nicht weiter wisst, wird das einen Grund haben der bereits andere zur selben Frage getrieben hat. Schaut euch hier gründlich um, dann brauchen wir auch nicht in Zukunft auf dieses FAQ verweisen ^^

##Hinweis:** Viele der nachfolgenden Fragen könnte man auch mit /menu beantworten.
...
Verwende /insel setshop

#### Wie setze ich meinen Insel Teleport um?
Verwende /insel sethome
...
Beim update auf die Version 1.13 sind die Pets leider etwas in Mitleidenschaft gezogen worden. Beim Stallmeister am Spawn bekommst du ein neues.
